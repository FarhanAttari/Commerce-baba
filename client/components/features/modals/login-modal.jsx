                                    ...
                                    <div className="form-tab">
                                        <Tabs selectedTabClassName="show" defaultIndex={0}>
                                            ...
                                            <div className="tab-content">
                                                ...
                                                <TabPanel>
                                                    <form onSubmit={handleSubmit(saveauto)} >
                                                        <div className="form-group">
                                                            <label htmlFor="register-email-2">Your email address *</label>
                                                            {/* <input {...register("email")} type="email" className="form-control" id="register-email-2" name="register-email" required /> */}
                                                            <input {...register("email")} type="email" className="form-control" required />
                                                        </div>

                                                        <div className="form-group">
                                                            <label htmlFor="register-password-2">Password *</label>
                                                            {/* <input {...register("password")} type="password" className="form-control" id="register-password-2" name="register-password" required /> */}
